...
{yellow}|\---/{bblue}C{yellow}\---/{bgreen}Y{yellow}\---/{byellow}B{yellow}\---/{bpurple}E{yellow}\---/{white}R{yellow}\---/{bcyan}-{yellow}\---/{bred}D{yellow}\---/|
{white}|-\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /-|
{green}|--X--X--X--X--X--X--X--X--X--X--X--X--X--X--X--|
{yellow}|  |{bblue}T {yellow}|{bblue}O {yellow}|{bblue}O {yellow}|{bblue}L {yellow}|{bblue}:-{yellow}|  |{bpurple}B {yellow}|{bpurple}Y {yellow}|  |{bcyan}K {yellow}|{bcyan}. {yellow}|{bcyan}D {yellow}|{bcyan}. {yellow}|{bcyan}O {yellow}|  |  
{white}|__|__|__|__|__|__|__|__|__|__|__|__|__|__|__|__|
{green}|                                               |
...
{red}[{byellow}2{red}]{white}-{red}>{bcyan}R.Y     : Instgram
...
""")
    ...
    try:
        if option=="1":
            ...
            os.system("xdg-open https://www.instagram.com/ry_c_i_a/ > /dev/null 2>&1 &")
        elif option=="0":
            logic()
        else:
